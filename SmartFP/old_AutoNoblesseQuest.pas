...
begin
  ...
  if (LeadDlg(31042, 8, 2, 1)) then begin
	  Delay(1000);
	  WriteToDB('Melody1');
  end;
end;
...
begin
	...
	while (User.DistTo(x, y, myZ) > 100) do begin
		if (User.Dead) or (count > 38) then begin //counter = 20, is 25 sec?
